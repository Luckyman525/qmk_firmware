...
#define PRODUCT Foundry
#define DESCRIPTION QMK keyboard firmware test for Foundry

/* key matrix size */
#define MATRIX_ROWS 5
#define MATRIX_COLS 12

#define MATRIX_ROW_PINS { TEENSY_PIN14, TEENSY_PIN15, TEENSY_PIN18, TEENSY_PIN19, TEENSY_PIN20 }
#define MATRIX_ROW_IOPINS { TEENSY_PIN14_IOPORT, TEENSY_PIN15_IOPORT, TEENSY_PIN18_IOPORT, TEENSY_PIN19_IOPORT, TEENSY_PIN20_IOPORT }
