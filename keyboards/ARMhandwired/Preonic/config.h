...
#define MATRIX_COL_PINS { TEENSY_PIN11, TEENSY_PIN10, TEENSY_PIN9, TEENSY_PIN8, TEENSY_PIN7,\
                          TEENSY_PIN6, TEENSY_PIN5, TEENSY_PIN4, TEENSY_PIN3, TEENSY_PIN2,\
                          TEENSY_PIN1, TEENSY_PIN0 }
#define MATRIX_COL_IOPINS { TEENSY_PIN11_IOPORT, TEENSY_PIN10_IOPORT, TEENSY_PIN9_IOPORT, TEENSY_PIN8_IOPORT, TEENSY_PIN7_IOPORT,\
                          TEENSY_PIN6_IOPORT, TEENSY_PIN5_IOPORT, TEENSY_PIN4_IOPORT, TEENSY_PIN3_IOPORT, TEENSY_PIN2_IOPORT,\
                          TEENSY_PIN1_IOPORT, TEENSY_PIN0_IOPORT }
